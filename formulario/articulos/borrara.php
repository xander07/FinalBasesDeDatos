...
<body bgcolor ="black" background="">
  ...
  <div class="banner">
      ...
      <div class="contenedor">
          <h2 class="banner__titulo"> Bienvenido al menú de borrado de articulos</h2>
          <p class="banner__txt">Aquí podrás borrar articulos.</p>
      </div>
  </div>

  <main class="main">
    <div class="formulario">
      <form action="delete_a.php" class="form-group" method="post">
          ...
          <select name="id" required>
              ...
              if($result){ 
                  foreach($result as $fila){
                    ?>
                    <option><?=$fila['codigoArticulo'];?></option>
                  <?php
                  }                 
              }
              ?>
